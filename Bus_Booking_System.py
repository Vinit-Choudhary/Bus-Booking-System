...
def Seat_Booking():
    ...
    lbl_jdate=Label(fr_show,text='Journey Date',font=('Arial',15))
    ...
    def showbus():
        ...
        cur.execute('''select distinct bus.B_id,operator.Opr_name,bus.B_type,run.Run_seatavailable,bus.B_capacity,bus.B_fare
                    from route
...
label1 = Label(root, text="Online Bus Booking System",fg='red',bg='light green',pady=5,font=("Helvetica", 24))
label1.pack(pady=10)
Label(root,text="Name:VINIT CHOUDHARY",fg='blue',font=('Helvetica',15)).pack(pady=10)
Label(root,text="Er : 221B444",fg='blue',font=('Helvetica',15)).pack(pady=10)
Label(root,text="Mobile: XXXXXXXXXX",fg='blue',font=('Helvetica',15)).pack(pady=10)
Label(root,text="Submitted to: Dr. Mahesh Kumar",fg='red',bg='light green',font=('Helvetica',15)).pack(pady=10)
